...
| File | Size | Download |
|------|------|----------|
| `x-ui-linux-amd64.tar.gz` | 67.9 MB | [⬇️ Download](https://raw.githubusercontent.com/Erforias/LatestReleaseMirror/main/releases/MHSanaei/3x-ui/x-ui-linux-amd64.tar.gz) |
<!-- RELEASES_END -->
